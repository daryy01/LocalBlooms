    ...
    <header className="bg-white shadow-md px-4 py-3">
      <nav className="flex justify-between items-center container mx-auto">
        ...
        <div className="flex items-center gap-3">
          <h1 className="text-2xl font-extrabold text-pink-600">HAyswww</h1>
        </div>
        ...
        <div className="hidden sm:flex items-center gap-6 text-gray-600">
          <Link
            to="/"
            className="flex items-center gap-2 hover:text-pink-700 transition-all"
          >
            <FaHome /> Home
          </Link>
          <Link
          ...
          <Link
            to="/cart"
            className="flex items-center gap-2 hover:text-pink-700 relative"
          >
